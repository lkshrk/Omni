...
| `groups.create` | high | CLI+TUI | state | cli_blackbox, integration, parity, tui_blackbox | parity (Stage 6) | cli_blackbox: `github.com/lkshrk/omni/integration_tests.TestCLIBinaryGroupLifecyclePersistsHostReferences`; integration: `github.com/lkshrk/omni/integration_tests.TestCLI/groups-management`; tui_blackbox: `github.com/lkshrk/omni/integration_tests.TestTUIGroupsCreatePersistsNewGroup` |
...
| `settings.provider` | high | CLI+TUI | state | cli_blackbox, integration, parity, tui_blackbox | parity (Stage 6); tui_blackbox (Stage 5) | cli_blackbox: `github.com/lkshrk/omni/integration_tests.TestCLIBinaryProviderTogglePersistsPerHost`; integration: `github.com/lkshrk/omni/integration_tests.TestCLI/settings-management` |
| `settings.reset` | high | CLI+TUI | state | cli_blackbox, integration, parity, tui_blackbox | parity (Stage 6); tui_blackbox (Stage 5) | cli_blackbox: `github.com/lkshrk/omni/integration_tests.TestCLIBinarySettingsResetPreservesInventory`; integration: `github.com/lkshrk/omni/integration_tests.TestCLI/settings-management` |
| `settings.reset_cache` | high | CLI+TUI | state | cli_blackbox, integration, parity, tui_blackbox | parity (Stage 6); tui_blackbox (Stage 5) | cli_blackbox: `github.com/lkshrk/omni/integration_tests.TestCLIBinarySettingsResetCacheRemovesCachedTools`; integration: `github.com/lkshrk/omni/integration_tests.TestCLI/settings-management` |
