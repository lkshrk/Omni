...
| `setup.init` | high | CLI+TUI | state | cli_blackbox, integration, parity, tui_blackbox | cli_blackbox (Stage 5); parity (Stage 6) | integration: `github.com/lkshrk/omni/integration_tests.TestCLI/init-import-config`; tui_blackbox: `github.com/lkshrk/omni/integration_tests.TestTUIFirstRunCreatesHostAndReachesDashboard` |
...
| `tools.delete` | high | CLI+TUI | state | cli_blackbox, integration, parity, tui_blackbox | cli_blackbox (Stage 5); parity (Stage 6) | integration: `github.com/lkshrk/omni/integration_tests.TestCLI/tools-provider-lifecycle`; integration: `github.com/lkshrk/omni/integration_tests.TestCLI/tools-remove-purge-no-provider`; tui_blackbox: `github.com/lkshrk/omni/integration_tests.TestTUIAdminTerminalCompletesInteractiveBrewCaskUninstall` |
