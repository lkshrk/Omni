...
| `dots.status` | high | CLI+TUI | query | cli_blackbox, integration, parity, tui_blackbox | parity (Stage 6) | cli_blackbox: `github.com/lkshrk/omni/integration_tests.TestCLIBinaryDotsStatusReportsManagedFileDrift`; integration: `github.com/lkshrk/omni/integration_tests.TestCLI/dots-status-entries`; tui_blackbox: `github.com/lkshrk/omni/integration_tests.TestTUIDotsRefreshDetectsBrokenLinkWithoutMutatingIt` |
...
| `groups.edit_dots` | high | TUI | — | integration, tui_blackbox | tui_blackbox (Stage 5) | integration: `github.com/lkshrk/omni/integration_tests.TestCLIBinaryGroupsEditDotsPersistsExactMembership` |
