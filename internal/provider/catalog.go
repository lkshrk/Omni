...
var builtinMetadata = map[string]Metadata{
	...
	"apt":    {Kind: ProviderKindConcrete, Ecosystem: EcosystemSystem, DisplayOrder: 110},
	"apk":    {Kind: ProviderKindConcrete, Ecosystem: EcosystemSystem, DisplayOrder: 120},
	"dnf":    {Kind: ProviderKindConcrete, Ecosystem: EcosystemSystem, DisplayOrder: 130},
	"pacman": {Kind: ProviderKindConcrete, Ecosystem: EcosystemSystem, DisplayOrder: 140},
	"zypper": {Kind: ProviderKindConcrete, Ecosystem: EcosystemSystem, DisplayOrder: 150},
